...
func main() {
	...
	retryErr := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		...
		patchBytes, _ := json.Marshal(result)
		res, err := client.Resource(gvr).Namespace(namespace).Patch(context.TODO(), "demo-deployment", types.JSONPatchType, patchBytes, metav1.PatchOptions{})
		log.Print(res)
...
//patchmerge
// https://github.com/kubernetes/client-go/blob/master/examples/dynamic-create-update-delete-deployment/main.go
// change update to patch, use dynamic client(gvr) (get firstly...)
